...
namespace X1APServer.Service.Utils
{
    public static class DBUtils
    {
        ...
        //TingYu 
        public static CervixQuestion GetCervixQuestion(int AIMID)
        {
            CervixQuestion cervixQuestion = new CervixQuestion();
            string ConnectionString = System.Configuration.ConfigurationManager.AppSettings["ConnectionStringTemplate"];
